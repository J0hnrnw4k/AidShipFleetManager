...
public class Lab2 {
    ...
    private static void printRecordLine(AidShip aidShip) {
        ...
        System.out.printf("|%-12s", aidShip.getAidType()); // NOTE: this prints aidType under "Helipad" per driver
    }

    private static void deleteAidShip() throws IOException {
        System.out.println("\n\nDelete Aid Ship\n");
        System.out.println("\nEnter Registration Number: ");
        String registrationNumber = InputValidator.readString();
        ...
        char answer = InputValidator.readChar("Invalid input. Enter Y or y to confirm: ");
